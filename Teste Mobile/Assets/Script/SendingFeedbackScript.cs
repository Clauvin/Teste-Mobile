...
public class SendingFeedbackScript : MonoBehaviour
{
    ...
    private const string good_title_message = "Thanks";
    private const string good_body_message = "Thanks for your feedback, you can uninstall this app now. :)";

    private const string bad_title_message = "Something went wrong";
    private const string bad_body_message = "Something went wrong, please enter in contact with" +
